...
class GetAllNameImageFiltrosCupcake {
    ...
    static async execute({ cupcakeModel, tiempo, dificultad, festividad, colorpredominante, colorsecundario }) {
        try {
            ...
            throw new Error(`[CupcakeService] Fallo en GetAllNameImageFiltrosCupcake: ${err.message}`);
        }
    }
}
