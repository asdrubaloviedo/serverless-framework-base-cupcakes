...
const PackageController = require('@package/controller/package');
...
const normalize = (event) => {
  ...
  // 3) módulo paquetes (ej: /paquetes)
  const mod = ensureSlash(process.env.PACKAGE_MODULE || 'paquetes');
  p = strip(p, mod);
...
const routes = {
  'GET /usuario-paquetes-faltantes': (e) => PackageController.getAll(qs(e)),
};
