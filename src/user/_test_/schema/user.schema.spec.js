...
describe('user/schema/user', () => {
  ...
  describe('validateCreateUserMedalLeage', () => {
    ...
    test('ok: email válido y medalla (coerce number)', () => {
      const out = S.validateCreateUserMedalLeage({
        email: 'a@a.com',
        medalla: '5'
      });
    ...
    test('error: email no string -> mensaje de tipo', () => {
      ...
      /*
       * No dependemos del texto exacto de Zod porque puede
       * variar ligeramente entre versiones.
       */
      const msg = out.error.issues[0].message;

      expect(
        msg
      ).toMatch(/(must be a string|expected string)/i);
    });
  ...
  describe('validatePatchUserMedalLeage', () => {
    ...
    test('ok: email + cupcake (coerce number)', () => {
      const out = S.validatePatchUserMedalLeage({
        email: 'a@a.com',
        cupcake: '2'
      });
    ...
    test('ok: email + valor boolean (coerce boolean)', () => {
      ...
      /*
       * z.coerce.boolean() utiliza truthiness.
       *
       * Por eso el string "false", al no estar vacío,
       * termina convertido a true.
       */
      const out = S.validatePatchUserMedalLeage({
        email: 'a@a.com',
        valor: 'false'
    ...
    test('error: solo email -> refine "At least one field to update is required."', () => {
      ...
      expect(
        issue?.message
      ).toBe('At least one field to update is required.');
    });
  ...
  describe('validateCreateUser', () => {
    ...
    test('createUserSchema asigna PER cuando pais no viene', () => {
      const result = S.validateCreateUser({
        nombre: 'Juan Perez',
        email: 'test@test.com'
      });
  ...
  describe('validateGetUserPreferences', () => {

    test('ok: acepta email válido y lo normaliza', () => {
      const out = S.validateGetUserPreferences({
